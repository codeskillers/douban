<template>
    <div class="hotshowContainer">
       <div class="cinemaHot">
           <p class="hotshowTitle hot">近期热门</p>
       ...
       <div class="hotmoviesWrapper" ref="wrapper" scroll-x="true">
          <ul class="hotMovies" ref="ulWrapper">
                <router-link tag="li" :to="{path:'/mvDetail3',query: { index }}" v-for="(item,index) in hotShow" :key="index" class="movies-item">
...
export default {
   ...
   created() {
       this.$http.get('https://www.easy-mock.com/mock/5d023f7ba93a2a618f6ac0db/vue/hotrecent')
       .then(res=>{
           console.log(res);
